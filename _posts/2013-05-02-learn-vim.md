...
layout: post
title: "vim 攻略"
description: "最近看到一篇vim练级的文章，觉得甚好"
category: 
tags: [vim]
---
{% include JB/setup %}
...
上面的那些命令只能让你幸存下来，现在是时候学习一些更多的命令了，下面是我的建议：
...
![learn-vim-1](/assets/image/post/learn-vim-1.jpg)
...
![learn-vim-2](/assets/image/post/learn-vim-2.jpg)
...
![learn-vim-3](/assets/image/post/learn-vim-3.png)
...
![learn-vim-4](/assets/image/post/learn-vim-4.gif)
...
![learn-vim-5](/assets/image/post/learn-vim-5.gif)
